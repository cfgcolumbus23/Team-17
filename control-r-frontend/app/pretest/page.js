    ...
    return (
        <div className="flex w-full h-full justify-center items-center">
            <div className="p-3 flex-col w-2/3 justify-center mx-5">
                ...
                <Link className="bg-blue-500 p-4 rounded text-7xl flex" href={"https://www.digitalliteracyassessment.org/go/?module=13"} target="_blank" rel="noopener noreferrer">TAKE THE ASSESSMENT</Link>
